 ...
 */
public class PreferenceBaseWithIds   {
  private String channelAccessProfileReference = null;

  private String channelAccessPreferencesRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier 
   * @return channelAccessPreferencesRecordReference
  **/

  public String getChannelAccessPreferencesRecordReference() {
    return channelAccessPreferencesRecordReference;
  }

  public void setChannelAccessPreferencesRecordReference(String channelAccessPreferencesRecordReference) {
    this.channelAccessPreferencesRecordReference = channelAccessPreferencesRecordReference;
  }
